      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Pressable style={styles.checkRow} onPress={() => setChecked((v) => !v)}>
          <View style={[styles.checkbox, { backgroundColor: checked ? PALETTE.mint : PALETTE.cardBg }]}>
            {checked ? <Ionicons name="checkmark" size={20} color={PALETTE.text} /> : null}
          </View>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: PALETTE.cardBg, borderWidth: 1, borderColor: PALETTE.border, borderRadius: 16, padding: 16, gap: 14 },
  section: { gap: 4 },
  ...
  checkbox: { width: 32, height: 32, borderWidth: 1, borderColor: PALETTE.border, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
